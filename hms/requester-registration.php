...
<div class="row">
    <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        <div class="logo margin-top-30">
            <h2>Requester Registration</h2>
        </div>

        <div class="box-login">
            <form class="form-login" method="post" action="requester-registration2.php">
                <fieldset>
                    <legend>
                        Sign Up
                    </legend>
                    ...
                    <div class="form-group">
								<span class="input-icon">
                                    <textarea name="address" rows="2" cols="41" title="address" placeholder="Address" required></textarea>
