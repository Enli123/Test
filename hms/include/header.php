...
<header class="navbar navbar-default navbar-static-top">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">
            <h2 style="padding-top:2%; margin-top: 12px;">Blood Bank</h2>
        </a>
            ...
            <li class="dropdown current-user">
                <a href class="dropdown-toggle" data-toggle="dropdown">
                  <span class="username">
                      ...
                      if (isset($_SESSION['requester_name'])) {

                          $user_name = $_SESSION['requester_name'];
                ...
                <ul class="dropdown-menu dropdown-dark">
                    <li>
                        <a href="requester-edit-profile.php">
                            My Profile
                        </a>
                    </li>

                    <li>
                        <a href="requester-change-password.php">
                            Change Password
                        </a>
                    </li>
                    <li>
